...
{
    public partial class BasicDataCorrection_old : WebStyleBaseForEnergy.webStyleBase
    {
        ...
        {
            DataTable m_ResultTable = BalanceUI.Service.BasicDataCorrectionService_old.GetAbnormalData(myOrganizationId, myDeviationMagnification, myCorrectionObject, myMinValidValue, myStartTime, myEndTime, myStartTimeReference, myEndTimeReference);
            string m_ColumnString = BalanceUI.Service.BasicDataCorrectionService_old.GetColumnJsonString(m_ResultTable);
        ...
        {
            string m_DataBaseName = BalanceUI.Service.BasicDataCorrectionService_old.GetFactoryDataBase(myOrganizationId);
            DataTable m_AmmeterTagsTable = BalanceUI.Service.BasicDataCorrectionService_old.GetAmmeterInfoTable(m_DataBaseName);
        ...
        {
            string m_DataBaseName = BalanceUI.Service.BasicDataCorrectionService_old.GetFactoryDataBase(myOrganizationId);
            DataTable m_DCSTagsTable = BalanceUI.Service.BasicDataCorrectionService_old.GetDCSInfoTable(m_DataBaseName);
        ...
        {
            DataTable m_ResultTable = BalanceUI.Service.BasicDataCorrectionService_old.GetTrend(myOrganizationId, myStartTime, myEndTime, myAmmeterFieldNames, myDCSFieldNames);
            string m_ResultString = EasyUIJsonParser.DataGridJsonParser.DataTableToJson(m_ResultTable); 
            return m_ResultString;
        }
        [WebMethod]
        ...
        {
            string m_ResultString = BalanceUI.Service.BasicDataCorrectionService_old.CorrectionDataByTags(myOrganizationId, myStartTime, myEndTime, myAbnormalDataTime, myTagsInfo);
            return m_ResultString;
        }
        [WebMethod]
        public static string ReGenerateDataByDay(string myOrganizationId, string myStartTime, string myEndTime)
        {
            ...
            {
                string m_ResultString = BalanceUI.Service.BasicDataCorrectionService_old.ReGenerateDataByDay(myOrganizationId, myStartTime, myEndTime);
                return m_ResultString;
            }
            else
            {
